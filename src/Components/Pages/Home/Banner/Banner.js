        ...
        <div>
            <div className="banner-bg text-white">
                <div className='pl-20 pt-24'>
                    ...
                    <div>
                        <button className="btn btn-outline border-white rounded-3xl hover:bg-white text-white hover:text-black px-8 mt-5 mr-8 btn-font">Know More</button>
                        <button className="btn btn-outline border-white rounded-3xl hover:bg-white text-white hover:text-black px-8 mt-5 btn-font">Contact Me</button>
                    </div>
                </div>
            </div>
